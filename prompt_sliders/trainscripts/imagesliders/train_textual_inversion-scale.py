...
def train(args, folders, scales):
    ...
    for epoch in range(first_epoch, args.num_train_epochs):
        ...
        with accelerator.accumulate(text_encoder):
            # 7.7. Train with positive scale.
            ti_prompt_1 = train_util.encode_prompts_slider(tokenizer, text_encoder, [new_target], sc=scale_to_look)
            ...
            # 7.8. Train with negative scale.
            ti_prompt_2 = train_util.encode_prompts_slider(tokenizer, text_encoder, [new_target], sc=-scale_to_look)
