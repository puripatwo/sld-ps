...
def get_input_latents_list(
    ...
    # Generate background latents if not provided.
    ...
    for idx, obj_box in enumerate(so_boxes):
        ...
        # Blend background and foreground latents.
...
def compose_latents_with_alignment(
    ...
    **kwargs,
    ...
    # 1. Align the foreground latents with bounding boxes.
    ...
    # 2. Move objects to the new positions.
    ...
    # 5. Add background to the latent list.
    latents_all_list.append(latents_bg_lists)
    mask_tensor_list.append(bg_mask)

    # 6. Merge all latents into one final representation.
