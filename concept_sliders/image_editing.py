...
if __name__ == "__main__":
    ...
    for scale in scales:
        ...
        for t in tqdm(noise_scheduler.timesteps):
            ...
            combined_text_embeddings = torch.cat([uncond_embeddings_copy[cnt].expand(*text_embeddings.shape), text_embeddings])
            combined_text_embeddings = combined_text_embeddings.to(weight_dtype)
